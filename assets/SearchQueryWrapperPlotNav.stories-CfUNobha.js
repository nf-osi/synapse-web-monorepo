import{o as e}from"./preload-helper-CsHsquCd.js";import{U as t,tn as n}from"./SynapseConstants-C6NyDJfS.js";import{Ln as r,Nn as i}from"./synapse-client-DLEPPQHq.js";import{H as a,W as o,et as s,i as c,n as l,nt as u,r as d,t as f,tt as p}from"./iframe-ImKTyoiI.js";import{m,p as h}from"./CardContainerLogic-B13EJKcJ.js";var g,_,v,y,b,x;e((()=>{o(),c(),l(),p(),r(),n(),m(),{fn:g}=__STORYBOOK_MODULE_TEST__,_={title:`Explore/SearchQueryWrapperPlotNav`,component:h,parameters:{stack:`mock`,msw:{handlers:[a(i,{tableBundle:{columnModels:u.columnModels,maxRowsPerPage:25}}),...f(i),...d(i)]}},args:{searchIndexId:s,onQueryResultBundleChange:g()}},v={args:{name:`Search Results`,unitDescription:`result`,tableConfiguration:{columnLinks:[]},facetsToPlot:[`category`,`collections`,`topic`],availableFacets:[`category`,`collections`,`topic`,`dataTypes`,`isOpen`,`mature`,`registration`]}},y={args:{name:`Search Results`,cardConfiguration:{type:t,genericCardSchema:{type:`Standard`,title:`name`,subTitle:`acronym`,secondaryLabels:[`category`,`collections`,`topic`,`isOpen`]}},facetsToPlot:[`category`,`collections`,`topic`],availableFacets:[`category`,`collections`,`topic`,`dataTypes`,`isOpen`,`mature`,`registration`],defaultShowPlots:!0}},b={args:{name:`Search Results`,unitDescription:`result`,tableConfiguration:{},availableFacets:[`category`,`collections`,`topic`,`dataTypes`,`isOpen`,`mature`,`registration`],defaultShowPlots:!1,hideTopLevelControls:!1,hideQueryCount:!1}},v.parameters={...v.parameters,docs:{...v.parameters?.docs,source:{originalSource:`{
  args: {
    name: 'Search Results',
