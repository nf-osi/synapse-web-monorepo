import{o as e}from"./preload-helper-CsHsquCd.js";import{_ as t,i as n,t as r}from"./core-CI8DLeHF.js";import{Cn as i,on as a,t as o}from"./dist-DIvCtTVI.js";import{En as s,Mn as c,On as l,yt as u}from"./synapse-client-Bq-D85Gh.js";import{r as d}from"./mock_user_profile-BgSYjn5K.js";import{n as f,r as p}from"./mockFileEntity-eIC4yqtD.js";import{a as m,c as h,h as g,i as _,l as v,m as y,u as b}from"./mockAccessRequirements-DrG-L53F.js";import{At as x,C as S,Dt as C,Mt as w,Ot as T,U as E,W as D,a as O,f as k,jt as A,kt as j,o as M,u as N,w as P}from"./iframe-BFGX3j0y.js";import{r as F,t as I}from"./AccessRequirementList-p4jZGo4B.js";function L(e){return[n.get(`${l}/auth/v1/2fa`,()=>{let n={status:e?`ENABLED`:`DISABLED`};return t.json(n,{status:200})})]}var R,z,B,V,H,U,W,G,K,q;e((()=>{_(),A(),f(),x(),D(),P(),k(),M(),d(),s(),c(),o(),r(),F(),R={title:`Governance/Data Access Request Flow/AccessRequirementList`,component:I,parameters:{stack:`mock`},argTypes:{isAuthenticated:{control:{type:`boolean`}}},args:{isAuthenticated:!0}},z={args:{entityId:p.id,renderAsModal:!0},parameters:{msw:{handlers:[...E(l),...L(!1),...T(l),...C(l,void 0,[])]}}},B={parameters:{msw:{handlers:[...E(l),N(l,!0,!0),...L(!0),...T(l),...C(l),...j(l,[{accessRequirementId:b.id.toString(),concreteType:`org.sagebionetworks.repo.model.dataaccess.ManagedACTAccessRequirementStatus`,isApproved:!0,currentSubmissionStatus:{submissionId:w.id,submittedBy:w.submittedBy,modifiedOn:w.modifiedOn,state:a.APPROVED}},{accessRequirementId:y.id.toString(),concreteType:`org.sagebionetworks.repo.model.dataaccess.BasicAccessRequirementStatus`,isApproved:!0},{accessRequirementId:g.id.toString(),concreteType:`org.sagebionetworks.repo.model.dataaccess.BasicAccessRequirementStatus`,isApproved:!0},{accessRequirementId:m.id.toString(),concreteType:`org.sagebionetworks.repo.model.dataaccess.BasicAccessRequirementStatus`,isApproved:!0}]),...O(l)]}},args:{entityId:p.id,isAuthenticated:!0,renderAsModal:!0}},V=[...h,{...b,id:21},{...g,id:22},{...y,id:23},{...m,id:24}],H={parameters:{msw:{handlers:[...E(l),N(l,!0,!0),...L(!0),...T(l),...C(l,void 0,V),...j(l,[{accessRequirementId:b.id.toString(),concreteType:`org.sagebionetworks.repo.model.dataaccess.ManagedACTAccessRequirementStatus`,isApproved:!0,currentSubmissionStatus:{submissionId:w.id,submittedBy:w.submittedBy,modifiedOn:w.modifiedOn,state:a.APPROVED}},{accessRequirementId:y.id.toString(),concreteType:`org.sagebionetworks.repo.model.dataaccess.BasicAccessRequirementStatus`,isApproved:!0},{accessRequirementId:g.id.toString(),concreteType:`org.sagebionetworks.repo.model.dataaccess.BasicAccessRequirementStatus`,isApproved:!0},{accessRequirementId:m.id.toString(),concreteType:`org.sagebionetworks.repo.model.dataaccess.BasicAccessRequirementStatus`,isApproved:!0},{accessRequirementId:`21`,concreteType:`org.sagebionetworks.repo.model.dataaccess.ManagedACTAccessRequirementStatus`,isApproved:!1},{accessRequirementId:`22`,concreteType:`org.sagebionetworks.repo.model.dataaccess.BasicAccessRequirementStatus`,isApproved:!1},{accessRequirementId:`23`,concreteType:`org.sagebionetworks.repo.model.dataaccess.BasicAccessRequirementStatus`,isApproved:!1},{accessRequirementId:`24`,concreteType:`org.sagebionetworks.repo.model.dataaccess.BasicAccessRequirementStatus`,isApproved:!1}]),...O(l),...S(l),n.post(`${l}${u}`,()=>{let e={requirementId:m.id,submitterId:`999`,accessorId:`999`,state:i.APPROVED,id:123,etag:`etag`,createdOn:new Date().toISOString(),modifiedOn:new Date().toISOString(),createdBy:`999`,modifiedBy:`999`};return t.json(e,{status:201})})]}},args:{entityId:p.id,isAuthenticated:!0,renderAsModal:!0}},U={parameters:{msw:{handlers:[...E(l),N(l,!0,!1),...L(!0),...T(l),...C(l),...j(l,[{accessRequirementId:y.id.toString(),concreteType:`org.sagebionetworks.repo.model.dataaccess.BasicAccessRequirementStatus`,isApproved:!1}]),...O(l),n.post(`${l}${u}`,()=>{let e={requirementId:y.id,submitterId:`999`,accessorId:`999`,state:i.APPROVED,id:123,etag:`etag`,createdOn:new Date().toISOString(),modifiedOn:new Date().toISOString(),createdBy:`999`,modifiedBy:`999`};return t.json(e,{status:201})})]}},args:{entityId:p.id,renderAsModal:!0,isAuthenticated:!0}},W={parameters:{msw:{handlers:[...E(l),N(l,!1,!0),...L(!0),...T(l),...C(l),...j(l,[{accessRequirementId:y.id.toString(),concreteType:`org.sagebionetworks.repo.model.dataaccess.BasicAccessRequirementStatus`,isApproved:!1}]),...O(l),n.post(`${l}${u}`,()=>{let e={requirementId:y.id,submitterId:`999`,accessorId:`999`,state:i.APPROVED,id:123,etag:`etag`,createdOn:new Date().toISOString(),modifiedOn:new Date().toISOString(),createdBy:`999`,modifiedBy:`999`};return t.json(e,{status:201})})]}},args:{entityId:p.id,renderAsModal:!0,isAuthenticated:!0}},G={parameters:{msw:{handlers:[...E(l),N(l,!0,!0),...L(!0),...T(l),...C(l,void 0,[b]),...j(l,[{accessRequirementId:b.id.toString(),concreteType:`org.sagebionetworks.repo.model.dataaccess.ManagedACTAccessRequirementStatus`,isApproved:!1,currentSubmissionStatus:{submissionId:w.id,submittedBy:w.submittedBy,modifiedOn:w.modifiedOn,state:a.REJECTED,rejectedReason:`Thank you for requesting access, but you were rejected. Here's why:
 * You did not meet the requirements.
 * Another reason: you did not meet the requirements.
Feel free to apply again.`}}]),...O(l),...S(l)]}},args:{entityId:p.id,isAuthenticated:!0,renderAsModal:!0}},K={args:{entityId:p.id,isAuthenticated:!0,renderAsModal:!0},parameters:{msw:{handlers:[...E(l),N(l,!0,!0),...L(!0),...T(l),...C(l,void 0,[v]),...j(l,[{accessRequirementId:v.id.toString(),concreteType:`org.sagebionetworks.repo.model.dataaccess.BasicAccessRequirementStatus`,isApproved:!1}]),...O(l)]}}},z.parameters={...z.parameters,docs:{...z.parameters?.docs,source:{originalSource:`{
  args: {
