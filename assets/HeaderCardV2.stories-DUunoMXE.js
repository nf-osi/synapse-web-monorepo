import{o as e}from"./preload-helper-CsHsquCd.js";import{t}from"./jsx-runtime-l3w3GfrB.js";import{H as n,t as r}from"./themed_icons-D19L4Vni.js";import{n as i,t as a}from"./HeaderCardV2-DuBhsHaJ.js";var o,s,c,l,u;e((()=>{r(),i(),o=t(),s={title:`Synapse/HeaderCardV2`,component:a,parameters:{layout:`centered`},tags:[`autodocs`]},c={args:{type:`defaultType`,title:`Default HeaderCard`,description:`This is a default header card`,values:[{columnDisplayName:`Label 1`,value:`Value 1`},{columnDisplayName:`Label 2`,value:`Value 2`},{columnDisplayName:`Label 3`,value:`Value 3`}],secondaryLabelLimit:3,isAlignToLeftNav:!1,descriptionConfig:{showFullDescriptionByDefault:!0},icon:(0,o.jsx)(n,{})}},l={args:{type:`Study`,title:`Synodos NF2`,subTitle:`Jaishri Blakeley, D. Wade Clapp, James Gusella, Scott Plotkin`,description:`Synodos for NF2 is a first-of-its-kind neurofibromatosis research collaboration dedicated to defeating the rare genetic disorder neurofibromatosis type 2 (NF2)...`,values:[{columnDisplayName:`Study Status`,value:`Completed`},{columnDisplayName:`Data Status`,value:`Available`},{columnDisplayName:`Disease Focus`,value:`Neurofibromatosis type 2`},{columnDisplayName:`Manifestation`,value:`Schwannoma, Meningioma`},{columnDisplayName:`Funding Agency`,value:`CTF`},{columnDisplayName:`Institutions`,value:`Johns Hopkins Medicine, Indiana University, Massachusetts General Hospital, Harvard Medical School, University of Central Florida, FLI-Leibniz-Germany, University of North Carolina, Ohio State University, Sage Bionetworks, Children's Tumor Foundation`},{columnDisplayName:`On Synapse`,value:`syn2343195`},{columnDisplayName:`Grant DOI`,value:`https://doi.org/10.48105/pc.gr.88541, https://doi.org/10.48105/pc.gr.88552`}],secondaryLabelLimit:8,isAlignToLeftNav:!1,descriptionConfig:{showFullDescriptionByDefault:!0},icon:(0,o.jsx)(n,{})}},c.parameters={...c.parameters,docs:{...c.parameters?.docs,source:{originalSource:`{
  args: {
    type: 'defaultType',
...
}`,...l.parameters?.docs?.source}}},u=[`Default`,`StudyHeaderCardV2`]}))();export{c as Default,l as StudyHeaderCardV2,u as __namedExportsOrder,s as default};