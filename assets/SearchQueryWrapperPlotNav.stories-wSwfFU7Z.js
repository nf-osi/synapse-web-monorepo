import{o as e}from"./preload-helper-CsHsquCd.js";import{$t as t,H as n}from"./SynapseConstants-neVNjr8v.js";import{An as r,En as i}from"./synapse-client-B63VS642.js";import{J as a,L as o,Y as s,i as c,n as l,q as u,r as d,t as f,z as p}from"./iframe-Cmy3XeDd.js";import{m,p as h}from"./CardContainerLogic-nfTvVPKw.js";var g,_,v,y,b,x;e((()=>{p(),c(),l(),a(),r(),t(),m(),{fn:g}=__STORYBOOK_MODULE_TEST__,_={title:`Explore/SearchQueryWrapperPlotNav`,component:h,parameters:{stack:`mock`,msw:{handlers:[o(i,{tableBundle:{columnModels:s.columnModels,maxRowsPerPage:25}}),...f(i),...d(i)]}},args:{searchIndexId:u,onQueryResultBundleChange:g()}},v={args:{name:`Search Results`,unitDescription:`result`,tableConfiguration:{columnLinks:[]},facetsToPlot:[`category`,`collections`,`topic`],availableFacets:[`category`,`collections`,`topic`,`dataTypes`,`isOpen`,`mature`,`registration`]}},y={args:{name:`Search Results`,cardConfiguration:{type:n,genericCardSchema:{type:`Standard`,title:`name`,subTitle:`acronym`,secondaryLabels:[`category`,`collections`,`topic`,`isOpen`]}},facetsToPlot:[`category`,`collections`,`topic`],availableFacets:[`category`,`collections`,`topic`,`dataTypes`,`isOpen`,`mature`,`registration`],defaultShowPlots:!0}},b={args:{name:`Search Results`,unitDescription:`result`,tableConfiguration:{},availableFacets:[`category`,`collections`,`topic`,`dataTypes`,`isOpen`,`mature`,`registration`],defaultShowPlots:!1,hideTopLevelControls:!1,hideQueryCount:!1}},v.parameters={...v.parameters,docs:{...v.parameters?.docs,source:{originalSource:`{
  args: {
    name: 'Search Results',
