import{o as e}from"./preload-helper-CsHsquCd.js";import{_ as t,i as n,t as r}from"./core-CI8DLeHF.js";import{Ft as i,Mn as a,Pn as o,Rn as s}from"./synapse-client-CmSRto0s.js";import{i as c,u as l}from"./mockAccessRequirements-DrG-L53F.js";import{At as u,Mt as d,St as f,a as p,bt as m,d as h,f as g,o as _,xt as v,yt as y}from"./iframe-Bh3FqCAx.js";import{n as b,t as x}from"./EDucPreviewStep-BTrbKl4q.js";var S,C,w,T,E;e((()=>{c(),f(),d(),m(),g(),_(),a(),s(),r(),b(),S={...l,eDucTemplateId:`template-abc-123`},C={title:`Governance/Data Access Request Flow/Managed Access Requirement/Step 2c - eDUC Preview`,component:x,parameters:{stack:`mock`,chromatic:{viewports:[600,1200]},msw:{handlers:[n.get(`${o}${i(v.id)}`,()=>t.json({fileHandleId:`mock-preview-file-handle-123`},{status:200})),...h(o),...p(o),...u(o),...y(o)]}}},w={name:`eDUC preview step`,args:{managedACTAccessRequirement:S,previewSrcOverride:`https://www.rd.usda.gov/sites/default/files/pdf-sample_0.pdf`}},T={name:`eDUC preview — error state`,parameters:{msw:{handlers:[n.get(`${o}${i(v.id)}`,()=>t.json({reason:`Preview could not be generated at this time.`},{status:500})),...h(o),...p(o),...u(o),...y(o)]}},args:{managedACTAccessRequirement:S}},w.parameters={...w.parameters,docs:{...w.parameters?.docs,source:{originalSource:`{
